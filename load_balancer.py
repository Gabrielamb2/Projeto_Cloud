...
def mostrar_subnets(ec2):
    response = ec2.describe_subnets()['Subnets']
    subnet_ids = []
...
def attach_to_load_balancer(auto_scalling_name, ec2, target_group_arn):
    try:
        print("Linkando Load Balancer com Target Group")
        ec2.attach_load_balancer_target_groups(
            AutoScalingGroupName=auto_scalling_name,
            TargetGroupARNs=[target_group_arn]
        )
        print("Load Balancer linkado com Target Group")
    except NameError as e:
        print(e)